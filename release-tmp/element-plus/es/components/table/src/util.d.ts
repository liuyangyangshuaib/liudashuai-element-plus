...
export declare function toggleRowStatus<T>(statusArr: T[], row: T, newVal?: boolean, tableTreeProps?: TreeProps, selectable?: (row: T, index?: number) => boolean, rowIndex?: number, rowKey?: string): boolean;
export declare function walkTreeNode(root: any, cb: any, childrenKey?: string, lazyKey?: string, lazy?: boolean): void;
