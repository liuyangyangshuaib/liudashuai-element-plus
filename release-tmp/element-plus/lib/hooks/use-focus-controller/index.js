...
function useFocusController(target, {
  ...
  const handleClick = (event) => {
    var _a, _b;
    if (((_a = wrapperRef.value) == null ? void 0 : _a.contains(document.activeElement)) && wrapperRef.value !== document.activeElement || aria.isFocusable(event.target) || disabled.value)
      return;
