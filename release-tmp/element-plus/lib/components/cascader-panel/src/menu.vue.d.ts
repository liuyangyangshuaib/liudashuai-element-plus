...
declare const _default: import("vue").DefineComponent<{
    ...
    clearHoverZone: () => void;
    virtualListHeight: import("vue").ComputedRef<number>;
    virtualItemSize: number;
    handleVirtualListScroll: (e: Event) => void;
    virtualListError: import("vue").Ref<boolean>;
    handleVirtualListError: () => void;
    showSelectAll: import("vue").ComputedRef<boolean>;
    selectAllText: import("vue").ComputedRef<string>;
    selectableNodes: import("vue").ComputedRef<CascaderNode[]>;
    checkedNodes: import("vue").ComputedRef<CascaderNode[]>;
    isAllSelected: import("vue").ComputedRef<boolean>;
    isIndeterminate: import("vue").ComputedRef<boolean>;
    isAllDisabled: import("vue").ComputedRef<boolean>;
    handleSelectAll: () => void;
    handleSelectAllChange: (checked: CheckboxValueType) => void;
    isSelectAllProcessing: import("vue").Ref<boolean>;
