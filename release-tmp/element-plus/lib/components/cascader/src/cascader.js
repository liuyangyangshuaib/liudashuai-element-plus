...
var index$a = require('../../cascader-panel/index.js');
...
var index$9 = require('../../../directives/click-outside/index.js');
...
const _sfc_main = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props, { expose, emit }) {
    ...
    expose({
      addNode: (val) => {
        var _a;
        (_a = cascaderPanelRef.value) == null ? void 0 : _a.addNode(val);
      },
      getCheckedNodes,
      cascaderPanelRef,
      togglePopperVisible,
        ...
        default: vue.withCtx(() => [
          vue.withDirectives((vue.openBlock(), vue.createElementBlock("div", {
            ...
            vue.unref(multiple) ? (vue.openBlock(), vue.createElementBlock("div", {
              ...
              vue.renderSlot(_ctx.$slots, "tag", { data: allPresentTags.value }, () => [
                  ...
                  return vue.openBlock(), vue.createBlock(vue.unref(index$7.ElTag), {
                    ...
                    default: vue.withCtx(() => [
                      tag.isCollapseTag === false ? (vue.openBlock(), vue.createElementBlock("span", { key: 0 }, vue.toDisplayString(tag.text), 1)) : (vue.openBlock(), vue.createBlock(vue.unref(index$4.ElTooltip), {
                        ...
                        content: vue.withCtx(() => [
                          vue.createVNode(vue.unref(index$8.ElScrollbar), { "max-height": _ctx.maxCollapseTagsTooltipHeight }, {
                            default: vue.withCtx(() => [
            ...
            [vue.unref(index$9["default"]), () => togglePopperVisible(false), vue.unref(contentRef)]
          ])
        ]),
        content: vue.withCtx(() => [
          vue.withDirectives(vue.createVNode(vue.unref(index$a.ElCascaderPanel), {
