      ...
      <template #default>
        <div ref="wrapperRef" :class="[
          ...
          <div ref="selectionRef" :class="[
            ...
            <div :class="[
              ...
              <input :id="inputId" ref="inputRef" v-model="states.inputValue" type="text" :name="name"
                ...
                aria-autocomplete="none" aria-haspopup="listbox" @keydown.down.stop.prevent="navigateOptions('next')"
          ...
          <div ref="suffixRef" :class="nsSelect.e('suffix')">
            <div v-if="iconComponent && !showClose" :class="[nsSelect.e('caret'), iconReverse]" />
            <el-icon v-if="showClose && clearIcon" :class="[
              nsSelect.e('icon'),
              nsSelect.e('clear'),
